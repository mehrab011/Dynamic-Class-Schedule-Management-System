   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img src="<?php echo web_root; ?>img/univlogo.png" height="23">
                Class Schedule Mnagement System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right"> 
                 ...
                 <li class="dropdown">
                    ...
                    <!--     <li><a href="<?php echo web_root; ?>admin/class/index.php?view=grades"><i class="fa  fa-graduation-cap fa-fw"></i> Grades</a>  -->
                         ...
                         <li><a href="<?php echo web_root; ?>admin/user/index.php?view=add"><i class="fa fa-user  fa-fw"></i> Faculty</a>
                            </li>
                    ...
                    <ul class="nav" id="side-menu">
                      ...
                      <?php } ?>
                        ...
                        <li>
                         ...
                         <?php if ($_SESSION['ACCOUNT_TYPE']=='Administrator') {  ?>
                          <li>
                            <a href="<?php echo web_root; ?>admin/user/index.php" ><i class="fa fa-user fa-fw"></i> Faculty </a>
